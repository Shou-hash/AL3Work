...
public: // メンバ関数
	...
	/// </summary>
	void CreateGameWindow(const std::wstring& title = L"DirectXGame", UINT windowStyle = WS_OVERLAPPEDWINDOW, int32_t clientWidth = kWindowWidth, int32_t clientHeight = kWindowHeight);
